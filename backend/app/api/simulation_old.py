...
def prepare_simulation():
    ...
    Request (JSON):
        {
            ...
            "use_llm_for_profiles": true,                 // Optional, Whether to use LLM to generate persona
    ...
    try:
        ...
        # Update simulation state (include pre-fetched entity count)
...
def get_simulation(simulation_id: str):
    ...
    try:
        ...
        # If simulation is ready, add runtime instructions
...
def get_simulation_history():
    ...
    try:
        ...
        # Enhance simulation data, read only from simulation files
        ...
        for sim in simulations:
            ...
            if run_state:
                ...
                # Use user-set total_rounds, if not set then use recommended rounds
            ...
            # Get associated project file list (at most 3 items)
...
def get_simulation_profiles(simulation_id: str):
    ...
    try:
        ...
        logger.error("GetProfileFailed", exc_info=True)
        return jsonify({
            "success": False,
            "error": str(e)
        }), 500
...
def get_simulation_profiles_realtime(simulation_id: str):
    ...
    try:
        ...
        logger.error("Real-time getProfileFailed", exc_info=True)
        return jsonify({
            "success": False,
            "error": str(e)
        }), 500
...
def get_simulation_config_realtime(simulation_id: str):
    ...
    try:
        ...
        logger.error("Real-time getConfigFailed", exc_info=True)
        return jsonify({
            "success": False,
            "error": str(e)
        }), 500
...
def generate_profiles():
    """
    Generate OASIS Agent Profile directly from knowledge graph (do not create simulation)
...
def start_simulation():
    ...
    try:
        ...
        enable_graph_memory_update = data.get('enable_graph_memory_update', False)  # Optional: Whether to enable knowledge graph memory update
        ...
        # Get knowledge graph ID (for knowledge graph memory update)
        graph_id = None
